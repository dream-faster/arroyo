...
```
$ helm install arroyo oci://ghcr.io/dream-faster/charts/arroyo --version 0.16.0-dev -f values.yaml
```
...
```
$ helm show values oci://ghcr.io/dream-faster/charts/arroyo --version 0.16.0-dev
```
